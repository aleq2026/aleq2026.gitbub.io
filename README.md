...
<div class="container">
    ...
    <p>
        Desde que estás conmigo, todo se siente diferente…
        más tranquilo, más alegre, más completo.
    </p>

    <p>
        Y la verdad, no necesito un día especial para quererte,
        pero sí quiero preguntarte algo:
    </p>

    <p><strong>¿Quieres ser mi San Valentín? ❤️</strong></p>

    <button onclick="mostrarRespuesta()">Sí quiero 💘</button>
